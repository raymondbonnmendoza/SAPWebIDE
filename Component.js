jQuery.sap.declare("com.sap.demotest.Component");
jQuery.sap.require("com.sap.demotest.dev.devapp");
jQuery.sap.require("com.sap.demotest.MyRouter");

sap.ui.core.UIComponent.extend("com.sap.demotest.Component", {
	metadata: {
		name: "TDG Demo App",
		version: "1.0",
		includes: [],
		...
		rootView: "com.sap.demotest.view.App",

		config: {
			resourceBundle: "i18n/messageBundle.properties",
			serviceConfig: {
				name: "ODataDemo",
				serviceUrl: "/destinations/Northwind/(S(m5vn4gpryznhvuilegydzm1l))/V2/OData/OData.svc/"
			}
		},

		routing: {
			config: {
				routerClass: com.sap.demotest.MyRouter,
				viewType: "XML",
				viewPath: "com.sap.demotest.view",
	...
	init: function() {
		...
		var oRootPath = jQuery.sap.getModulePath("com.sap.demotest");
		...
		var oModel;
		var externalURL = com.sap.demotest.dev.devapp.externalURL;
		var appContext;
		if (com.sap.demotest.dev.devapp.devLogon) {
			appContext = com.sap.demotest.dev.devapp.devLogon.appContext;
		}
