jQuery.sap.declare("com.sap.open.Component");
jQuery.sap.require("com.sap.open.MyRouter");

sap.ui.core.UIComponent.extend("com.sap.open.Component", {
	metadata: {
		name: "TDG Demo App",
		version: "1.0",
		includes: [],
		...
		rootView: "com.sap.open.view.App",
		...
		routing: {
			config: {
				routerClass: com.sap.open.MyRouter,
				viewType: "XML",
				viewPath: "com.sap.open.view",
	...
	init: function() {
		...
		var oRootPath = jQuery.sap.getModulePath("com.sap.open");
		...
		var oModel;
		var externalURL = com.sap.open.dev.devapp.externalURL;
		var appContext;
		if (com.sap.open.dev.devapp.devLogon) {
			appContext = com.sap.open.dev.devapp.devLogon.appContext;
		}
