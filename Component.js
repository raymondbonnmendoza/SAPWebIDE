jQuery.sap.declare("com.sap.open.offline.Component");
jQuery.sap.require("com.sap.open.offline.MyRouter");

sap.ui.core.UIComponent.extend("com.sap.open.offline.Component", {
	metadata: {
		name: "TDG Demo App",
		version: "1.0",
		includes: [],
		...
		rootView: "com.sap.open.offline.view.App",

		config: {
			resourceBundle: "i18n/messageBundle.properties",
			serviceConfig: {
				name: "ODataDemo",
				serviceUrl: "/destinations/Northwind/V2/(S(el4z0ai4t0xjoh5ny2x1eohl))/OData/OData.svc/"
			}
		},

		routing: {
			config: {
				routerClass: com.sap.open.offline.MyRouter,
				viewType: "XML",
				viewPath: "com.sap.open.offline.view",
	...
	init: function() {
		...
		var oRootPath = jQuery.sap.getModulePath("com.sap.open.offline");
		...
		var oModel;
		var externalURL = com.sap.open.offline.dev.devapp.externalURL;
		var appContext;
		if (com.sap.open.offline.dev.devapp.devLogon) {
			appContext = com.sap.open.offline.dev.devapp.devLogon.appContext;
		}
	...
	_setModel: function(oModel) {
		...
		var oDeviceModel = new sap.ui.model.json.JSONModel({
			...
			isOffline: !com.sap.open.offline.dev.devapp.isOnline
		});
		oDeviceModel.setDefaultBindingMode("OneWay");
		this.setModel(oDeviceModel, "device");

		if (window.cordova) {
			com.sap.open.offline.dev.devapp.deviceModel = oDeviceModel;
		}
