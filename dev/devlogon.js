jQuery.sap.declare("com.sap.open.dev.devlogon");

sap.ui.base.ManagedObject.extend("com.sap.open.dev.devlogon", {
	appContext: null,
	...
	constructor: function() {
		if (typeof com.sap.open.dev.devlogon.__instance === "object") {
			return com.sap.open.dev.devlogon.__instance;
		}
		com.sap.open.dev.devlogon.__instance = this;
	},
...
sap.Push.registerForNotificationTypes(nTypes, regSuccess, regFailure, processNotification, "41248767956"); //GCM Sender ID, null for APNS
}
