jQuery.sap.declare("com.sap.demotest.dev.devapp");
jQuery.sap.require("com.sap.demotest.dev.devlogon");

com.sap.demotest.dev.devapp = {
	smpInfo: {},
	externalURL: null,
	...
	onDeviceReady: function() {
		if (window.sap_webide_FacadePreview) {
			...
			var that = com.sap.demotest.dev.devapp;
			$.getJSON(".project.json", function(data) {
				...
				if (that.smpInfo.server && that.smpInfo.server.length > 0) {
					...
					that.devLogon = new com.sap.demotest.dev.devlogon();
