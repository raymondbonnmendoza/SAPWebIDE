jQuery.sap.require("com.sap.open.util.Formatter");
jQuery.sap.require("com.sap.open.util.Controller");

com.sap.open.util.Controller.extend("com.sap.open.view.Detail", {
	...
	onRouteMatched: function(oEvent) {
		...
		jQuery.when(this.oInitialLoadFinishedDeferred).then(jQuery.proxy(function() {
			...
			oIconTabBar.getItems().forEach(function(oItem) {
				oItem.bindElement(com.sap.open.util.Formatter.uppercaseFirstChar(oItem.getKey()));
			});
	...
	showEmptyView: function() {
		this.getRouter().myNavToWithoutHash({
			...
			targetViewName: "com.sap.open.view.NotFound",
			targetViewType: "XML"
		});
	},
