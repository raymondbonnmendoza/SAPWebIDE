jQuery.sap.require("com.sap.demotest.util.Formatter");
jQuery.sap.require("com.sap.demotest.util.Controller");

var self;
com.sap.demotest.util.Controller.extend("com.sap.demotest.view.Detail", {
	...
	onRouteMatched: function(oEvent) {
		...
		jQuery.when(this.oInitialLoadFinishedDeferred).then(jQuery.proxy(function() {
			...
			oIconTabBar.getItems().forEach(function(oItem) {
				oItem.bindElement(com.sap.demotest.util.Formatter.uppercaseFirstChar(oItem.getKey()));
			});
	...
	showEmptyView: function() {
		this.getRouter().myNavToWithoutHash({
			...
			targetViewName: "com.sap.demotest.view.NotFound",
			targetViewType: "XML"
		});
	},
