...
com.sap.open.offline.util.Controller.extend("com.sap.open.offline.view.Master", {
	/**
	...
	onRouteMatched: function(oEvent) {
		...
		this.getRouter().myNavToWithoutHash({
			...
			targetViewName: "com.sap.open.offline.view.Detail",
			targetViewType: "XML"
		});
	...
	refreshData: function() {
		...
		if (model.hasPendingChanges() || model.newEntryContext) {
			this.openCancelConfirmDialog();
			this._onConfirmAction = jQuery.proxy(function() {
				if (com.sap.open.offline.dev.devapp.isLoaded) {
