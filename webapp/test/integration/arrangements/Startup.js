sap.ui.define([
	"sap/ui/test/Opa5",
	"com/test/CloudConnector/CloudConnectorTest/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("com.test.CloudConnector.CloudConnectorTest.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "com.test.CloudConnector.CloudConnectorTest",
					async: true
				},
				hash: oOptions.hash,
		...
		iRestartTheAppWithTheRememberedItem : function (oOptions) {
			...
			this.waitFor({
				success : function() {
					oOptions.hash = "Flights/" + encodeURIComponent(sObjectId);
