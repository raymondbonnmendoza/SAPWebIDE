...
_onObjectMatched: function (oEvent) {
			...
			this.getModel().metadataLoaded().then(function () {
				var sObjectPath = this.getModel().createKey("SalesOrderSet", { SalesOrderID: sObjectId });
...
onPress: function(oEvent) {
			...
			oRouter.navTo("productDetails", {productId: oItem.getBindingContext().getObject().ProductID});
},
...
this.getOwnerComponent().oListSelector.clearMasterListSelection();
			...
			var sPath = oElementBinding.getPath(), oResourceBundle = this.getResourceBundle(), oObject = oView.getModel().getObject(sPath), sObjectId = oObject.SalesOrderID, sObjectName = oObject.CustomerName, oViewModel = this.getModel("detailView");
...
oViewModel.setProperty("/delay", iOriginalViewBusyDelay);
		...
		/**
	*@memberOf com.so.controller.Detail
	*/
onApprove: function () {
//This code was generated by the layout editor.
	MessageToast.show("The sales order has been approved.");
		},
		/**
	*@memberOf com.so.controller.Detail
	*/
onReject: function () {
//This code was generated by the layout editor.
	MessageToast.show("The sales order has been rejected.");
		}
	});
});