sap.ui.define([
		...
		return BaseController.extend("opensap.manageproducts.controller.Worklist", {
			...
			onDelete: function(oEvent) {
				this._deleteObject(oEvent.getSource().getBindingContext().getPath(), oEvent.getSource().getBindingContext());
			},
			
			_deleteObject : function (oPath, oContext) {
				var oModel = this.getModel();
				var oValue = oContext.getProperty("Name");
				oModel.remove(oPath);
				var sMessage = this.getResourceBundle().getText("deleteSuccess", [oValue]);
